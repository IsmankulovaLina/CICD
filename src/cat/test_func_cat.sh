...
testing()
{
    ...
    then
      (( SUCCESS++ ))
        #echo "fail:$FAIL success:$SUCCESS total:$COUNTER success cat $t"
    else
      (( FAIL++ ))
        #echo "fail:$FAIL success:$SUCCESS total:$COUNTER fail cat $t"
    fi
...
echo "CAT FAIL: $FAIL"
echo "CAT SUCCESS: $SUCCESS"
echo "CAT ALL: $COUNTER"
